...
MAIN_URL = 'http://localhost:7601/mn-cse-tenant-a'
...
class MyUser(HttpUser):
    ...
    def increase_users(self):
        ...
        # url = f"http://localhost:7603/mn-cse-tenant-c/{node_type.upper() if node_type.upper().startswith('AE-') else 'AE-' + node_type.upper()}/{item}/Data/la"
